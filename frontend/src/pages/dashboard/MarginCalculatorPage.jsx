      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-dark-100 rounded-xl border border-dark-200 p-6">
            <h3 className="font-semibold text-white mb-4">Account Parameters</h3>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full bg-dark-200 border border-dark-200 rounded-lg px-10 py-3 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none appearance-none"
                >
          ...
          <div className="bg-dark-100 rounded-xl border border-dark-200 p-6">
            <h3 className="font-semibold text-white mb-4">Trade Parameters</h3>
