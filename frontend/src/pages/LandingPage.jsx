...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden">
        ...
        <div className={`relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-8 transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="hidden lg:flex relative h-full items-center justify-center min-h-[400px]">
              {[
                { symbol: 'IAM', change: '+2.4%', isUp: true, x: 10, y: 8 },
                { symbol: 'ATW', change: '-1.2%', isUp: false, x: 70, y: 12 },
                { symbol: 'BCP', change: '+0.8%', isUp: true, x: 38, y: 2 },
                { symbol: 'BOA', change: '+1.5%', isUp: true, x: 2, y: 42 },
                { symbol: 'CIH', change: '-0.6%', isUp: false, x: 80, y: 48 },
                { symbol: 'HPS', change: '+3.2%', isUp: true, x: 52, y: 68 },
                { symbol: 'TQM', change: '-0.9%', isUp: false, x: 18, y: 75 },
                { symbol: 'LBV', change: '+1.1%', isUp: true, x: 40, y: 32 },
                { symbol: 'MASI', change: '+0.5%', isUp: true, x: 75, y: 75 },
              ].map((bubble, idx) => (
                <div
                  key={bubble.symbol}
                  ...
                  onMouseEnter={(e) => {
                    ...
                    wrapper.classList.add('exploding')
                    setTimeout(() => wrapper.classList.remove('exploding'), 5000)
                  }}
                >
                  {/* Main Bubble */}
                  <div
                    className={`bubble-main flex flex-col items-center justify-center rounded-full backdrop-blur-sm border cursor-pointer ${
                      bubble.isUp
                        ? 'bg-green-500/20 border-green-400/40 shadow-[0_0_20px_rgba(34,197,94,0.35)]'
                        : 'bg-red-500/20 border-red-400/40 shadow-[0_0_20px_rgba(239,68,68,0.35)]'
                    }`}
                    style={{ width: '64px', height: '64px', animationDelay: `${idx * 0.2}s` }}
                  >
                    <span className="text-white font-semibold text-[11px] tracking-wide">{bubble.symbol}</span>
                    <span className={`text-[9px] font-bold ${bubble.isUp ? 'text-green-400' : 'text-red-400'}`}>
                      {bubble.change}
                    </span>
                  </div>
                  {/* Particles */}
                  {[...Array(6)].map((_, i) => (
                    <span
                      key={i}
                      className={`particle-piece ${bubble.isUp ? 'bg-green-400' : 'bg-red-400'}`}
                      style={{ '--i': i }}
                    />
                  ))}
                </div>
      ...
      {/* AI Voice Assistant Section - Interactive Waves */}
      <section
        className="py-24 relative overflow-hidden bg-[#0A0E2E] group/section"
        onMouseMove={(e) => {
          const rect = e.currentTarget.getBoundingClientRect()
      ...
      >
        {/* Deep Blue Background with mouse-following glow */}
        <div className="absolute inset-0 bg-[#0A0E2E]" />
        <div
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(20)].map((_, i) => (
            <div
              key={i}
              className="absolute rounded-full animate-float-orb group-hover/section:animate-float-orb-fast"
              style={{
                width: `${Math.random() * 10 + 5}px`,
                height: `${Math.random() * 10 + 5}px`,
                left: `${Math.random() * 100}%`,
                top: `${Math.random() * 100}%`,
                background: `radial-gradient(circle, ${['#3B82F6', '#60A5FA', '#93C5FD', '#2563EB', '#1D4ED8'][Math.floor(Math.random() * 5)]}, transparent)`,
        ...
        <div className="absolute inset-0 overflow-hidden">
          <svg className="absolute w-full h-full" preserveAspectRatio="none">
            ...
            {/* Wave 1 */}
            <path
              className="animate-wave-path group-hover/section:animate-wave-path-fast"
              d="M-100,200 Q150,150 400,200 T900,200 T1400,200 T1900,200"
            ...
            {/* Wave 2 */}
            <path
              className="animate-wave-path-reverse group-hover/section:animate-wave-path-reverse-fast"
              d="M-100,250 Q200,300 450,250 T950,250 T1450,250 T1950,250"
            ...
            <path
              className="animate-wave-path group-hover/section:animate-wave-path-fast"
              d="M-100,300 Q100,350 350,300 T850,300 T1350,300 T1850,300"
            ...
            <path
              ...
              d="M0,350 Q200,300 400,350 T800,350 T1200,350 T1600,350 V500 H0 Z"
              fill="url(#waveGradient1)"
              opacity="0.1"
            />
            {/* Wave 5 - Filled */}
            <path
              className="animate-wave-fill-reverse"
              d="M0,380 Q250,330 500,380 T1000,380 T1500,380 V500 H0 Z"
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute w-[500px] h-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-0 group-hover/section:opacity-100 transition-opacity duration-300"
            style={{
              left: 'var(--mouse-x, 50%)',
              top: 'var(--mouse-y, 50%)',
          ...
          {/* Ripple rings */}
          <div
            className="absolute w-[200px] h-[200px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-500/20 opacity-0 group-hover/section:opacity-100 group-hover/section:animate-ripple-out"
            style={{
              left: 'var(--mouse-x, 50%)',
              top: 'var(--mouse-y, 50%)',
            }}
          />
          <div
            className="absolute w-[200px] h-[200px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-400/15 opacity-0 group-hover/section:opacity-100 group-hover/section:animate-ripple-out"
            style={{
              left: 'var(--mouse-x, 50%)',
              top: 'var(--mouse-y, 50%)',
              animationDelay: '0.2s'
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(30)].map((_, i) => (
            <div
              key={`sparkle-${i}`}
              className="absolute w-1 h-1 bg-blue-400 rounded-full opacity-0 group-hover/section:opacity-100 group-hover/section:animate-sparkle"
              style={{
                left: `${Math.random() * 100}%`,
                top: `${Math.random() * 100}%`,
